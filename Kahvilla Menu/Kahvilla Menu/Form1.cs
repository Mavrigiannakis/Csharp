namespace Kahvilla_Menu
{
    public partial class ruokalistaForm : Form
    {
        ...
        {
            meistaLB.Text = "Keudan oppilaskunnan kahvilla palvelee luokassa 320 välituntisin\n";
            ...
            meistaLB.Text += "juomien lisäksi virvokkeita sekä pientä puurtavaa ja makeisia\n";
